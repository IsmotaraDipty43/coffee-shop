...
const Navber = () => {
    return (
        <div className="navbar backdrop-blur-xl bg-white/30 z-50 fixed px-28">
            ...
            <div className="navbar-end hidden lg:flex">
                <ul className="menu menu-horizontal gap-10 text-lg font-semibold px-1">
                    <NavLink className={({ isActive }) => `font-bold ${(isActive ? 'text-warning' : 'hover:text-warning')}`}  to='/'>
                        Home
                    </NavLink>
                    <NavLink className={({ isActive }) => `font-bold ${(isActive ? 'text-warning' : 'hover:text-warning')}`}  to='/coffees'>
                    ...
                    <NavLink className={({ isActive }) => `font-bold ${(isActive ? 'text-warning' : 'hover:text-warning')}`} to='/dashbroad'>
                        Dashboard
                    </NavLink>
                </ul>
            </div>
